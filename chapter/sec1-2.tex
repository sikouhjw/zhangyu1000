\subsection{无穷小比阶}
	...
	\begin{ti}
		当 $x \to 0$ ，$(1 - \cos x)\ln\left( 1 + 2x^{3} \right)$ 是比 $x \sin x^{n}$ 高阶的无穷小，而 $x \sin x^{n}$ 是比 $\ee^{x\tan^{2} x} - 1$ 高阶的无穷小，则正整数 $n = $ \hone{2}.
	\end{ti}

	\begin{ti}
		当 $x \to 0^{+}$ 时，$\sqrt{1 + \tan \sqrt{x}} - \sqrt{1 + \sin\sqrt{x}}$ 是 $x$ 的 $k$ 阶无穷小，则 $k =$ \hone{2}.
	\end{ti}
	...
	\begin{ti}
		当 $x \to 0$ 时，$x - \sin x \cos x \cos 2x$ 与 $cx^{k}$ 为等价无穷小，则 $c=$ \hone{2}，$k=$ \hone{2}.
	\end{ti}

	\begin{ti}
		当 $x \to 0$ 时，$1 - \cos x \cos 2x \cos 3x$ 对于无穷小 $x$ 的阶数等于 \hone{2}.
	\end{ti}
	...
	\begin{ti}
		当 $x \to \uppi$ 时，若有 $\sqrt[4]{\sin\frac{x}{2}} - 1 \sim A(x - \uppi)^{k}$，则 $A=$\hone{2}，$k=$\hone{2}.
	\end{ti}
	...
	\begin{ti}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=0.25\textwidth]{figure/fig1-1-1.pdf}
